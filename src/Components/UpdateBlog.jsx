...
const UpdateBlog = () => {
  ...
  const handleUpdate = (data) => {
    ...
    fetch(`https://sapience-task-server.vercel.app/post/${_id}`, {
      method: "PUT",
      headers: {
          ...
          <Form onSubmit={handleSubmit(handleUpdate)} className="card-body">
            ...
            <div className="form-control">
              ...
              <textarea
                ...
                className="textarea h-40 input-bordered text-black bg-slate-300"
              />
            </div>

            <div className="form-control mt-6">
              <button className="btn btn-primary w-full">Updating Blog</button>
            </div>
          </Form>
        </div>
