    ...
    return (
        <div className="bg-[#ebe9eb]">
            <div className="px-6 pb-28 pt-10">
                <h1 className="text-center text-4xl font-semibold">Our Best Classes</h1>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 justify-items-center items-center mt-16">
